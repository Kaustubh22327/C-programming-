...
int main(){
    int choice;
    printf("WELCOME TO THE PROGRAM , PLEASE ENTER THE CHOICE NUMBER O TO GET THE LYRICS FOR");
    printf("1.Hanuman Chalisa \n");
    printf("2.Gaytri Mantra \n");
    printf("3.Ganesh Mantra\n");
    printf("4.Navkar Mantra\n");
    if(task==1){
        printf(Shri Guru Charan Saroj raj Nija manu Mukura sudhari
